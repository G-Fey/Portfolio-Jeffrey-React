    ...
    return (
        ...
        className="home">
            ...
            <article id="A_propos" className=" d-flex align-items-center ">
                ...
                <a onClick={()=>window.location.href='/Aboutme'} className="col-lg-7 animation"><div >
            ...
            <article id="portfolio" className=" d-flex align-items-center ">
                <Fade left cascade><div className="col-lg-4 pl-5">
                    <h2>Mes Projets</h2>
                ...
                <a onClick={()=>window.location.href='/Project'} className="travaux"><div>
                    <Lottie 
                        options={{
                            loop: true,
                            autoplay: true, 
