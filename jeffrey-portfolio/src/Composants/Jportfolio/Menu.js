...
class Menu extends Component {
    ...
    handleChange = () =>{
        ...
        let modes = this.state.mode.slice();

        switch (chemin) {
            case "/Aboutme":
                modes[0].pagehome = "d-none";
                modes[1].pagemoi = "d-block";
                modes[3].buttonretour = "d-block";

                break;
            case "/Project":
                modes[0].pagehome = "d-none";
                modes[2].pageproject = "d-block";
                modes[3].buttonretour = "d-block";
                ...
                <div className="navbar">
                    <ul className="nav-item">
                        ...
                        <Link
                            ...
                            duration={500}
                        >
                            <li className={classes[0].pagehome}> 
                        ...
                        <Link
                            ...
                            duration={500}
                        >
                            <li className={classes[1].pagemoi}> 
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"/>
                                <path fillRule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                                <path fillRule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/>
                        ...
                        <Link
                            ...
                            duration={500}
                        >
                            <li className={classes[2].pageproject}> 
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-lightning" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" d="M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09zM4.157 8.5H7a.5.5 0 0 1 .478.647L6.11 13.59l5.732-6.09H9a.5.5 0 0 1-.478-.647L9.89 2.41 4.157 8.5z"/>
                                </svg>
                                <span>PROJETS</span>
